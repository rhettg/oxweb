...
func PassesAllFilters(line JSONData, filters []Expression) (result bool, err error) {
...
func (f *RandomSample) Setup(fname string, args []Expression) (err error) {
	if len(args) != 1 {
...
func (f *RandomSample) Evaluate(data JSONData) (result interface{}, err error) {
...
func (f *EveryNth) Setup(fname string, args []Expression) (err error) {
	if len(args) != 1 {
...
func (f *EveryNth) Evaluate(data JSONData) (result interface{}, err error) {
